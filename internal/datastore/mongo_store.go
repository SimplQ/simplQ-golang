...
func (mongodb MongoDB) CreateQueue(queue db.Queue) db.QueueId {
    ...
    return db.QueueId(stringId)
}

func (mongodb MongoDB) ReadQueue(db.QueueId) db.Queue {
    panic("Not implemented")
}

func (mongodb MongoDB) PauseQueue(db.QueueId) {
    panic("Not implemented")
}

func (mongodb MongoDB) ResumeQueue(db.QueueId) {
    panic("Not implemented")
}

func (mongodb MongoDB) DeleteQueue(db.QueueId) {
    panic("Not implemented")
}
